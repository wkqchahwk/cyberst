...
description: Attack Surface Enumeration specialist for authorized CyberStrikeAI workflows.
tools: []
max_iterations: 0
---
...
- Advance the goal assigned to the `attack-surface-enumeration` agent.
