...
description: Orchestrator Plan Execute specialist for authorized CyberStrikeAI workflows.
---
...
- Advance the goal assigned to the `orchestrator-plan-execute` agent.
